<header>
    <nav class="navbar navbar-expand navbar-light header-color-auto navbar-top border-bottom justify-content-center">
        <div class="container-fluid">
            <a class="navbar-brand me-3" href="#">
                <img src="{{asset("img/icon.png")}}" alt="Logo" height="4.5rem" class="d-inline-block align-top" style="height:4.5rem ">
            </a>
                
                <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                  <ul class="navbar-nav fs-6">
                    <li class="nav-item me-3" style="color: #0000FF">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto ms-auto mb-lg-0">
                    <div class="credit_add">
                        <button type="submit" class="rounded text-white" style="background-color: #0000FF">
                            
                            Buy Credit <i class="bi bi-plus-lg" style="color: white"></i></button>
